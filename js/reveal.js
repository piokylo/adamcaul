...
(function( root, factory ) {
	...
	function onDocumentKeyDown( event ) {
		...
		if( triggered === false ) {
			...
			switch( event.keyCode ) {
				...
				// k, up
				case 75: case 38: navigateUp(),  removeOnScroll(),moveBackgroundBack(); break;
				// j, down
				case 74: case 40: navigateDown(),  addOnScroll(), moveBackground() ; break;
				// home
	...
	console.log(event);
		...
		if( Date.now() - lastMouseWheelStep > 1000 ) {
